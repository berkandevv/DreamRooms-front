...
> [repositorio principal](https://github.com/berkandevv/DreamRooms) con Docker.
> Estas instrucciones son para arrancar **solo el frontend a mano**, sin Docker,
> clonando este repositorio por separado.
